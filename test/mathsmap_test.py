...
class TestMathsMap(unittest.TestCase):
    ...
    def test_mathsmap_with_three_cards_and_a_link(self):
        ...
        new_map = MathsMap(name="Two cards", flashcard_dicts={id1:card1, id2:card2, id3:card3}, links=[(id1,id2)])
    ...
    def test_mathsmap_with_many_cards_and_many_links(self):
        ...
        map_ = MathsMap(name="Two cards", flashcard_dicts=cards, links=links)
